...
from eeevqa.utils.eval.ai2d.metrics import create_result_dict, calculate_acc, get_answer_pair, Accuracy
...
class Pix2StructVanilla(LightningModule):
    ...
    def training_step(self, batch, batch_idx=0):
        ...
        self.train_accuracy_metric.update(text_predictions, batch_pop("raw_output"))

        self.log("train_acc", self.train_accuracy_metric, on_step=True, on_epoch=True, prog_bar=True, sync_dist=True, batch_size = self.eval_batch_size)
    ...
    def validation_step(self, batch, batch_idx=0):
        ...
        self.val_accuracy_metric.update(text_predictions, batch_pop("raw_output"))
